...
const bundleDir = path.join("dist")
const bundleFile = path.join("index.bundle")
...
const bundleCommand = {
    ...
    options: [
        ...
        },
        {
            ...
            description: 'Directory name where to store the resulting bundle, ex. /dist',
            default: bundleDir
        },
        {
            name: '--bundle-file <string>',
            description: 'File name where to store the resulting bundle, ex. /dist',
            default: bundleFile
        },
        // {
        //     name: '--assets-dest <string>',
        //     description: 'Directory name where to store assets referenced in the bundle',
        //     default: (config) => path.join(config.root, distDir)
        // },
        {
